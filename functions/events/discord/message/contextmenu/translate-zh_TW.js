...
let translated = await translate(text, {to: 'zh-TW'});
 ...
 */
  ...
  await lib.discord.webhooks['@0.0.0'].execute({
    ...
    username: `${webhook_name} [${context.params.event.data.resolved.messages[0].author.username}#${context.params.event.data.resolved.messages[0].author.discriminator}] - 翻譯成繁體中文(zh-TW)`,
